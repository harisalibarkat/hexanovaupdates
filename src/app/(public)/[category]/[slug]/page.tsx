      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          ...
          <article className="lg:col-span-2 min-w-0">
            ...
            {/* Meta bar */}
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2.5 text-sm text-muted-foreground mb-8 pb-6 border-b border-border/60">
              {/* Created date */}
              <time dateTime={post.createdAt.toISOString()} className="flex items-center gap-1.5" title="Created">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="15" y1="12" y2="12"/>
                </svg>
              ...
              {/* Published date */}
              {post.publishedAt && (
                <time dateTime={post.publishedAt.toISOString()} className="flex items-center gap-1.5" title="Published">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
