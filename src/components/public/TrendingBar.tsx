...
export function TrendingBar({ posts }: Props) {
  ...
  return (
    <div className="overflow-hidden flex items-stretch mb-8 bg-zinc-950 dark:bg-zinc-900 border border-zinc-800/80">
      {/* Label */}
      <div className="px-4 py-3 flex items-center gap-2 flex-shrink-0 bg-brand border-r border-white/10">
